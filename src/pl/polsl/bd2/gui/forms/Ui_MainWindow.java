...
**
** Created: Cz 27. wrz 17:26:11 2012
...
public class Ui_MainWindow implements com.trolltech.qt.QUiForm<QMainWindow>
{
    ...
    public QComboBox comboBoxSubject;
    ...
    public QPushButton buttonAddContestParticipant;
    public QPushButton buttonEditConestParticipant;
    public QPushButton buttonRemoveConestParticipant;
    public QSpacerItem horizontalSpacer_4;
    public QSpacerItem horizontalSpacer;
    public QVBoxLayout verticalLayout_7;
    public QLabel label_8;
    public QTableView contestTable;
    ...
    public void setupUi(QMainWindow MainWindow)
    {
        ...
        verticalLayout_5.addWidget(comboBoxSubject);
        ...
        tabWidget.addTab(tab, com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Podgl\u0105d ucznia", null));
        tab_2 = new QWidget();
        ...
        buttonAddContestParticipant = new QPushButton(tab_3);
        buttonAddContestParticipant.setObjectName("buttonAddContestParticipant");

        horizontalLayout_2.addWidget(buttonAddContestParticipant);

        buttonEditConestParticipant = new QPushButton(tab_3);
        buttonEditConestParticipant.setObjectName("buttonEditConestParticipant");

        horizontalLayout_2.addWidget(buttonEditConestParticipant);

        buttonRemoveConestParticipant = new QPushButton(tab_3);
        buttonRemoveConestParticipant.setObjectName("buttonRemoveConestParticipant");

        horizontalLayout_2.addWidget(buttonRemoveConestParticipant);
        ...
        contestTable = new QTableView(tab_3);
        contestTable.setObjectName("contestTable");

        verticalLayout_7.addWidget(contestTable);
        ...
        webView = new QWebView(tab_7);
        webView.setObjectName("webView");
        webView.setUrl(new QUrl("about:blank"));

        verticalLayout_12.addWidget(webView);

        tabWidget.addTab(tab_7, com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Pomoc", null));
...
"	margin: 0px;\n"+
"}", null));
        labelNameStudent.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Imi\u0119:", null));
        labelNameEditStudent.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "xxx", null));
        labelSurnameStudent.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Nazwisko:", null));
        labelSurnameEditStudent.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "xxx", null));
        labelClassStudent.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Klasa:", null));
        labelClassEditStudent.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "xxx", null));
        label.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Ucze\u0144t:", null));
        label_17.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Przedmiot:", null));
        labelProgramInData.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Nazwa_Przedmiotu", null));
        buttonToogleDetailsData.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Poka\u017c szczeg\u00f3\u0142owe informacje", null));
        tabWidget.setTabText(tabWidget.indexOf(tab), com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Podgl\u0105d ucznia", null));
        ...
        buttonAddContestParticipant.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Dodaj uczestnika", null));
        buttonEditConestParticipant.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Edytuj uczestnika", null));
        buttonRemoveConestParticipant.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Usu\u0144 uczestnika", null));
        label_8.setText(com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Uczestnicy konkursu:", null));
        ...
        tabWidget.setTabText(tabWidget.indexOf(tab_7), com.trolltech.qt.core.QCoreApplication.translate("MainWindow", "Pomoc", null));
    } // retranslateUi
