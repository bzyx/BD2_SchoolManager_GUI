...
public class MainWindow extends QMainWindow {
	...
	private void teacherGui() {
		...
		if (dataPresenter != null) {
			ui.tableDetailUsers.setModel(dataPresenter
					.getTableDetailsDataModel());
		}
		...
		for (PupilModel.Pupil.ClassPupilMock classPupil : this.pupilMock
				.getClassPupil()) {
			ui.comboBoxClass.addItem(Integer.toString(classPupil
					.getClassPupil()));
		}
	}
