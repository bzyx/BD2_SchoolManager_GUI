...
public class UserData{
	...
	static public List<UserDataMock> userDataConteiner;
	{
		...
		details1.add(new DetailsDataMock(new Date(), 4, "kartk�wka", "Bardzo B�azen"));
		details2.add(new DetailsDataMock(new Date(), 4, "kartk�wka", "Bardzo B�azen"));
		...
		details4.add(new DetailsDataMock(new Date(), 4, "kartk�wka", "-"));
		...
		data2.add(new DataMock("Chi�ski", 3, "6, 4, 2", 4, 3, details4));
		userDataConteiner.add(new UserDataMock("Adam", data1));
		userDataConteiner.add(new UserDataMock("J�zek", data2));
	}
